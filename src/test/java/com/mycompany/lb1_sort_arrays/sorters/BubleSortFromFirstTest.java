 ...
 * @author YARUS
 */
public class BubleSortFromFirstTest {
    
    public BubleSortFromFirstTest() {
    }
    ...
    public void testSortDataChange() {
        ...
        BubleSortFromFirst sorter = new BubleSortFromFirst();
        sorter.sort(array);
